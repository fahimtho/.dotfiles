#This is the default YTFZF_PREFconfig file
...
#(YTFZF_EXTMENU)
external_menu="rofi -no-fixed-num-lines -yoffset "-400" -theme /home/fh1m/.config/ytfzf/yt.rasi -dmenu -p  '輸 '"  
